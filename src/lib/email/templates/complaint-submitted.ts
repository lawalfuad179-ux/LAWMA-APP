...
<h1 style="margin:0 0 8px;font-size:20px;color:${emailTheme.text}">Report submitted</h1>
<p style="margin:0 0 16px;font-size:15px;color:${emailTheme.muted};line-height:1.5">
We received your report regarding <strong>${issueType.replace(/_/g, ' ')}</strong>.
</p>
<div style="padding:12px;background:${emailTheme.surface};border-radius:${emailTheme.radius};margin-bottom:24px;font-size:14px;color:${emailTheme.brand};font-weight:600">Ticket: ${ticketId}</div>
