...
<h1 style="margin:0 0 16px;font-size:20px;color:${emailTheme.text}">${title}</h1>
<p style="margin:0 0 24px;font-size:15px;color:${emailTheme.muted};line-height:1.5">${body}</p>
